...
$file_name = str_replace(' ', '', $files['archivo']['name']);
  $file_tmp = $files['archivo']['tmp_name'];
 /* GUARDAMOS LA IMG TEMPORALMENTE */

move_uploaded_file($file_tmp, $_SERVER['DOCUMENT_ROOT'] . getFolderProject() . '/archivos/' . $file_name); /* INDICAMOS LA RUTA DONDE SE VA ALMACENAR ESA IMAGEN */
